        ...
        <div class="wrap-login100 p-l-50 p-r-50 p-t-72 p-b-50">
            ...
            <form class="login100-form validate-form"  method="POST" action="{{route('password.update')}}"  >
                ...
                <div class="wrap-input100 validate-input" data-validate = "Required">
                    ...
                    <input class="input100" type="password" name="current_password" id="password" placeholder="Enter Your current password">
                    <i class="fa fa-eye" id="togglePassword" style="margin-left: -30px; cursor: pointer;"></i>
                    <span class="focus-input100"></span>
                </div>
                <div class="wrap-input100 validate-input" data-validate = "Required">
                    <span class="label-input100">New Password *</span>
                    <input class="input100" type="password" name="new_password" id="new_password" placeholder="Enter Your New password">
                    <i class="fa fa-eye" id="togglePassword2" style="margin-left: -30px; cursor: pointer;"></i>
                    <span class="focus-input100"></span>
                </div>
                <div class="wrap-input100 validate-input" data-validate = "Required">
                    <span class="label-input100">Confirm Password *</span>
                    <input class="input100" type="password" id="password_confirmation" name="password_confirmation" placeholder="confirm your password">
                ...
                <div class="container-login100-form-btn">
                    <div class="wrap-login100-form-btn">
                        ...
                        <input type="submit" class=" login100-form-btn btn btn-submit" value="Change Password" name="submit" style="color: white; cursor: pointer;background-color: #0285A1" >
                    </div>
