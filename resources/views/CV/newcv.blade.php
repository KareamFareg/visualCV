...
<div id="capture">
    <section class="main3"  style="background-color: #1581B0 ">
                        ...
                        @if($cv->about != null)
                            <tr>
                                ...
                                <td>
                                    ...
                                    <p style="text-align: left;padding-left: 20px" contenteditable="true"> {!! $cv->about !!} </p>
                                </td>
                        ...
                        @if($cv->education != null)
                            <tr>
                                ...
                                <td>
                                    ...
                                    <p style="text-align: left;padding-left: 20px" contenteditable="true">{!! $cv->education!!}</p>
                                </td>
                            </tr>
                        @endif
                        @if($cv->experience != null)
                            <tr>
                                ...
                                <td>
                                    ...
                                    <p style="text-align: left;padding-left: 20px" contenteditable="true">{!! $cv->experience !!}</p>
                                </td>
                        ...
                        @if($cv->skills != null)
                            <tr>
                                ...
                                <td>
                                    ...
                                    <p style="text-align: left;padding-left: 20px" contenteditable="true">{!! $cv->skills !!}</p>
                                </td>
                            </tr>
                        @endif
                        @if($cv->courses != null)
                            <tr>
                                ...
                                <td>
                                    ...
                                    <p style="text-align: left;padding-left: 20px" contenteditable="true">{!! $cv->courses !!}</p>
                                </td>
                            </tr>
                        @endif
                        @if($cv->projects != null)
                            <tr>
                                ...
                                <td>
                                    ...
                                    <p style="text-align: left;padding-left: 20px" contenteditable="true">{!! $cv->projects !!}</p>
                                </td>
                            </tr>
                        @endif
                        @if($cv->languages != null)
                            <tr>
                                ...
                                <td>
                                    ...
                                    <p style="text-align: left;padding-left: 20px" contenteditable="true">{!! $cv->languages !!}</p>
                                </td>
                            </tr>
                        @endif
                        @if($cv->vulWorks != null)
                            <tr>
                                ...
                                <td>
                                    ...
                                    <p style="text-align: left;padding-left: 20px" contenteditable="true">{{$cv->vulWorks}}</p>
                                </td>
                            </tr>
                        @endif
                        @if($cv->hobbits != null)
                            <tr>
                                ...
                                <td>
                                    ...
                                    <p style="text-align: left;padding-left: 20px" contenteditable="true">{{$cv->hobbits}}</p>
                                </td>
                            </tr>
                        @endif
                        @if($cv->portfolio != null)
                            <tr>
                                ...
                                <td>
                                    ...
                                    <p style="text-align: left;padding-left: 20px" contenteditable="true"><a hrf="{{$cv->portfolio}}">{!! $cv->portfolio !!}</a></p>
                                </td>
                            </tr>
                        @endif
                    </table>
