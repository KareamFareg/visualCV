...
<div class="limiter">
    <div class="container-login100">
        ...
        <div class="wrap-login100 p-l-50 p-r-50 p-t-72 p-b-50">
            ...
            <form class="login100-form validate-form" method="post"  action="{{route('editCV',['id' => $cv->id])}}" enctype="multipart/form-data">
                @csrf
                ...
                <div class="wrap-input100 validate-input" data-validate="Required">
                    ...
                    <textarea class="input100"  name="jobTitle" placeholder="Enter Your Job Title ..." id="title" >{{$cv->jobTitle}}</textarea>
                ...
                <div class="wrap-input100 validate-input" data-validate="Required">
                    ...
                    <textarea class="input100" type="text" name="about" placeholder="enter some phrases about you ..." id="profile">{{$cv->about}}</textarea>
                    @error('about')<span class="focus-input100 text-danger">{{$message}}</span>@enderror
                </div>

                <div class="wrap-input100 validate-input"  data-validate="Required">
                    <span class="label-input100">Education</span>
                    <input class="input100" type="text" name="education" placeholder="Enter Your  college..." value="{{$cv->education}}" id="education">
                ...
                <div class="wrap-input100 validate-input" data-validate="Required">
                    ...
                    <textarea class="input100" type="text" name="experience" placeholder="Enter your experience with dates..." id="experience">{{$cv->experience}}</textarea>
                    @error('education')<span class="focus-input100 text-danger">{{$message}}</span>@enderror
                </div>

                <div class="wrap-input100 validate-input" data-validate = "Required">
                    <span class="label-input100">Skills </span>
                    <textarea class="input100"  name="skills" placeholder="Enter Your Skills seperated by - " id="skills">{{$cv->skills}}</textarea>
                    @error('skills')<span class="focus-input100 text-danger">{{$message}}</span>@enderror
                </div>

                <div class="wrap-input100 validate-input" >
                    <span class="label-input100">Projects</span>
                    <textarea class="input100" name="projects" placeholder="Enter your projects...." id="projects">{{$cv->projects}} </textarea>
                    @error('projects')<span class="focus-input100 text-danger">{{$message}}</span>@enderror
                </div>
                <div class="wrap-input100 validate-input" >
                    <span class="label-input100">Courses</span>
                    <textarea class="input100"  name="courses" placeholder="Enter your courses...." id="courses">{{$cv->courses}}</textarea>
                    @error('courses')<span class="focus-input100 text-danger">{{$message}}</span>@enderror
                </div>
                <div class="wrap-input100 validate-input">
                    <span class="label-input100">Languages</span>
                    <textarea class="input100"  name="languages" placeholder="Enter your languages...." id="languages">{{$cv->languages}}</textarea>
                    @error('languages')<span class="focus-input100 text-danger">{{message}}</span>@enderror
                </div>
                <div class="wrap-input100 validate-input" >
                    <span class="label-input100">Exercises</span>
                    <textarea class="input100" name="vulWorks" placeholder="Enter your sharing Exercises...." id="vulWorks">{{$cv->vulWorks}}</textarea>
                    @error('vulWorks')<span class="focus-input100 text-danger">{{$message}}</span>@enderror
                </div>
                <div class="wrap-input100 validate-input">
                    <span class="label-input100">Hobbits</span>
                    <textarea class="input100" name="hobbits" placeholder="Enter your Hobbits...." id="hobbits">{{$cv->hobbits}}</textarea>
                    @error('hobbits')<span class="focus-input100 text-danger">{{$message}}</span>@enderror
                </div>
                <div class="wrap-input100 validate-input" >
                    <span class="label-input100">Portfolio</span>
                    <input class="input100"  name="portfolio" placeholder="Enter your Portfolio URL...." value="{{$cv->portfolio}}" id="portfolio">
                    @error('portfolio')<span class="focus-input100 text-danger">{{$message}}</span>@enderror
                </div>
                <div class="wrap-input100 validate-input" data-validate = "Required">
                    <span class="label-input100">Your CV Image</span>
                    <input class="input100" type="file" name="cvphoto" placeholder="Select your Photo " >
